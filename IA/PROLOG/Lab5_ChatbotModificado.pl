...
tema_hombre :- 
    write('¿Te gustaría hablar de futbol soccer, automóviles o tortugas? (escribe futbol, automoviles o tortugas entre comillas simples)'), nl,
    read(Respuesta),
    (Respuesta == 'futbol' -> tema_futbol ;
     Respuesta == 'automoviles' -> tema_automoviles ;
     Respuesta == 'tortugas' -> tema_tortugas ;
     write('Respuesta no válida. Por favor, escribe ''futbol'', ''automoviles'' o ''tortugas''.'), nl, tema_hombre).
...
% Módulo de tema de tortugas
tema_tortugas :- 
    write('¿Te gustaría saber sobre tortugas marinas o tortugas terrestres? (escribe marinas o terrestres entre comillas simples)'), nl,
    read(Tipo),
    (Tipo == 'marinas' -> info_tortugas_marinas ;
     Tipo == 'terrestres' -> info_tortugas_terrestres ;
     write('No tengo información sobre ese tipo de tortugas. Por favor, escribe ''marinas'' o ''terrestres''.'), nl, tema_tortugas),
    preguntar_continuar_hombre.

% Información sobre tortugas marinas
info_tortugas_marinas :- 
    write('Las tortugas marinas son reptiles que pasan la mayor parte de su vida en el agua
